...
# Configure mock clients for testing
config :code_reviewer, :ai_client, CodeReviewer.AIClientMock
config :code_reviewer, :github_client, CodeReviewer.GitHubClientMock
